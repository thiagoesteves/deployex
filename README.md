...
- [ ] Migration execution during the full deployment
- [ ] OTP Distribution monitoring for health checks
- [ ] Convert to a Phoenix app for a dashboard view status
...
To see this approach in action, have a look at this (project)[TBD] that leverages this deployment using Terraform for creating cloud environments integrated with Deployex for orchestrating Elixir application management.
