defmodule DeployexWeb.Components.ApplicationCard do
  @moduledoc false
  ...
  def content(assigns) do
    ~H"""
    <div
      id={Helper.normalize_id("button-application-card-#{@application.sname}")}
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-3 gap-3">
              <div class="bg-base-200 border border-base-300 rounded-lg p-3 hover:bg-base-100/30 transition-colors">
                ...
                <.connected? status={@application.otp} />
              </div>
              ...
              <div class="bg-base-200 border border-base-300 rounded-lg p-3 hover:bg-base-100/30 transition-colors">
                ...
                <.restarts restarts={@application.crash_restart_count} />
              </div>

              <div
                :if={@application.last_deployment}
                class="bg-base-200 border border-base-300 rounded-lg p-3 hover:bg-base-100/30 transition-colors"
              >
                <div class="flex items-center gap-2 mb-2">
                ...
                <.deployment deployment={@application.last_deployment} />
              </div>
