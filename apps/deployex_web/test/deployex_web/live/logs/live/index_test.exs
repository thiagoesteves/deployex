defmodule DeployexWeb.Logs.Live.IndexTest do
  ...
  test "Check long messages are being printed", %{
    ...
    message = """
    17:16:25.917 [error] This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not, This is a very long message with many words to test if the app is truncate or not.
    """
