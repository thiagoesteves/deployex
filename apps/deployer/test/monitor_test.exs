  ...
  describe "Running applications" do
    test "Running application - no executable path - elixir", %{
      ...
      assert capture_log(fn ->
               ...
               "Version: 1.0.0 set but no /tmp/deployex-test/var/lib/deployex/service/#{name}/#{sname}/current/bin/#{name}"
    end
    ...
    test "Running application - no executable path - gleam", %{
      ...
      assert capture_log(fn ->
               ...
               "Version: 1.0.0 set but no /tmp/deployex-test/var/lib/deployex/service/#{name}/#{sname}/current/erlang-shipment"
    end
