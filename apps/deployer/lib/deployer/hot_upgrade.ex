defmodule Deployer.HotUpgrade do
  ...
  ## Examples
      ...
      iex> Deployer.HotUpgrade.deployex_check("/tmp/hotupgrade/deployex-0.9.1.tar.gz")
      {:ok, %Check{}}
  """
  ...
  ## Examples
      ...
      iex> Deployer.HotUpgrade.deployex_execute("/tmp/hotupgrade/deployex-0.9.1.tar.gz")
      :ok
  """
