defmodule Deployex.Catalog do
  ...
  """
  @impl true
  @spec bin_path(integer(), String.t(), Deployex.Catalog.Adapter.bin_service()) :: String.t()
  ...
  """
  @impl true
  @spec config() :: Deployex.Catalog.Config.t()
  def config, do: default().config() || %Deployex.Catalog.Config{}

  @doc """
  Update the current deployex dynamic configuration
  """
  @impl true
  @spec config_update(Deployex.Catalog.Config.t()) :: {:ok, Deployex.Catalog.Config.t()}
